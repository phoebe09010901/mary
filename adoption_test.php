...
//dogs list
$query = "select Fullkey, file1, name, sex, breed, neuter, years, month, weight from ".$table_name_dogs." where pub=1 order by sort desc";
...
<div id="wrapper_center">
    ...
    <?php include('include_top_test.php');?>    
    	...
    	<div class="adoption_2">  
        	...
        	<div class="adoption_2_all">
              ...
              <div class="adoption_2_2">
                	...
                	<!-- 小麥 這是未選取前的狀態 
                    <div class="wist_icon_01" id="wist_icon_<?php echo $i+1;?>"><a href="javascript:;"><img src="images/wistlist_icon_03.png" width="100%" /></a></div>
                    <div class="wist_icon_03" id="wist_icon3_<?php echo $i+1;?>"><a href="javascript:;"><img src="images/wistlist_icon_04.png" width="100%" /></a></div>
                    -->
                    
                    <!-- 小麥 這是已選取前的狀態 -->
                    <div class="wist_icon_01" id="wist_icon_<?php echo $i+1;?>"><a href="javascript:;"><img src="images/wistlist_icon_04.png" width="100%" /></a></div>
