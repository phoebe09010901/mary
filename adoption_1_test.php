...
<div class="selectbar">
	<?php if($prev_id){ ?>
	<a class="article-navi article-navi-prev" href="adoption_1_test.php?dog_id=<?=$prev_id?>" style="opacity: 0">
	...
	<?php } ?>
	<?php if($next_id){ ?>
	<a class="article-navi article-navi-next" href="adoption_1_test.php?dog_id=<?=$next_id?>" style="opacity: 0">
...
<div id="wrapper_center">
	...
	<!----------- 內容 開始 ------------------> 
  	<div class="adoption2">
    	<!-- 小麥 這是未選取前的狀態 
        <div class="wist_icon_02" id="wist_icon_1"><a href="javascript:;"><img src="images/wistlist_icon_03.png" width="100%" /></a></div>
        <div class="wist_icon_04" id="wist_icon3_1"><a href="javascript:;"><img src="images/wistlist_icon_04.png" width="100%" /></a></div>
        -->
                    
        <!-- 小麥 這是已選取前的狀態 -->
        <div class="wist_icon_02" id="wist_icon_1"><a href="javascript:;"><img src="images/wistlist_icon_04.png" width="100%" /></a></div>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                            <tr>
                                                                ...
                                                                <td align="right" valign="top">
                                                                    <span class="in_btn_app1"><a class="fancybox fancybox.iframe" href="wistlist_01.php">APPLY</a></span>
		...
		<tr>
			<td>
				<div class="pro_rescue_photo_block">
                  	<div class="photo"><a class="example-image-link" href="album_photos/57/IMG_7713.JPG" data-lightbox="example-set" data-title="IMG_7713.JPG"><img src="album_photos/57/IMG_7713.JPG" height="100%" /></a></div>
                    <div class="photo"><a class="example-image-link" href="album_photos/57/IMG_7713.JPG" data-lightbox="example-set" data-title="IMG_7713.JPG"><img src="album_photos/57/IMG_7713.JPG" height="100%" /></a></div>
                    <div class="photo"><a class="example-image-link" href="album_photos/57/IMG_7713.JPG" data-lightbox="example-set" data-title="IMG_7713.JPG"><img src="album_photos/57/IMG_7713.JPG" height="100%" /></a></div>
                    <div class="photo"><a class="example-image-link" href="album_photos/57/IMG_7713.JPG" data-lightbox="example-set" data-title="IMG_7713.JPG"><img src="album_photos/57/IMG_7713.JPG" height="100%" /></a></div>
