	...
	<!----------- 內容 開始 ------------------> 
  	<div class="boardingList_adoption">
        ...
        <div style="border:#03C 0px solid; width:980px; height:658px;">
            <div style="border:#F90 1px solid; width:980px; height:116px;">
                <div style="width:100%; text-align:center; margin-top:30px;"><span class="font-family_01 color_02 font-size_57">FEBRUARY 28, 2015</span></div>
            </div>
            <br /><br />
                ...
                <div class="adoption_2" style="margin-top:5px;">  
                    ...
                    <div class="boardingList_adoption_2_all_first">
                        ...
                        <div class="boardingList_adoption_2_2">
                            ...
                            <span class="center1">Adopter：Joni Matalacage<br />Cell：209-914-6208<br />Home：209-914-6208<br />mommyof2plus@sbcglobal.net</span>
                        </div>
                    </div>
