...
class adjustdatetime {	
	...
	var $hours;
	//該時區正確時間
	function time_zone($format_data, $time_zone) {
	...
	//計算兩個日期相差天數
	function twodate_days($fromdate, $todate) {
