...
function search_form($this_page, $array_search, $match_row, $query_string) {
	...
	?><div style="float:left; padding-top:6px;"><input name="search_type" type="radio" id="search_type1" value="all" checked="CHECKED"> <label for="search_type1">全部</label>&nbsp;&nbsp;<input name="search_type" type="radio" value="pub1" id="search_type2"> <label for="search_type2">上架</label>&nbsp;&nbsp;<input name="search_type" type="radio" value="pub0" id="search_type3"> <label for="search_type3">下架</label>&nbsp;&nbsp;</div><?php
	}
