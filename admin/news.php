...
$query = "select Fullkey, news_date, title, hit_counts, pub, create_time, edit_time from $table_name where lang='".$_SESSION[Login_System_User]['lang']."' $where_str order by news_date desc";
        ...
        <input type="hidden" name="action" id="action" value="">
          <table width="100%"  cellspacing="2" cellpadding="0" border="0">
              ...
              <tr>
                ...
                <td align="center"><?=$news['news_date']?></td>
