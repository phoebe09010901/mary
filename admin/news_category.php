        ...
        <input type="hidden" name="action" id="action" value="">
          <table width="100%"  cellspacing="2" cellpadding="0" border="0">
              ...
              for ($i=0; $i<$page_num; $i++){
                ...
                ?>
              <tr>
                <td align="center"><button type="button" class="editbtn edit_w25" title="編輯" onClick="real_edit(<?=$cate['Fullkey']?>)">r</button></td>
                ...
                <td align="center"><a href="<?=($cate['lv']<News_Category_Lv_Num)?'news_category.php?prev='.$cate['Fullkey']:'news.php?category='.$cate['Fullkey']?>"><?=$cate['name']?></a></td>
