...
<div class="admin-panel">
  <?php include("include_menu.php"); ?><!--slidebar end-->
   ...
   <ul class="topbar">
      <a href="index.php"><li class="left">首頁</li></a><a href="dogs.php"><li class="left"><?=$dogs['name']?></li></a>
            ...
            <table class="<?=$main_str?>-table">
              <tbody>  
                <tr>
                  ...
                  <td align="left"><input type="radio" name="q1" id="q1_1" value="1" <?php if($form['q1']==1){echo 'checked';} ?>>Low　<input type="radio" name="q1" id="q1_2" value="2" <?php if($form['q1']==2){echo 'checked';} ?>>Medium　<input type="radio" name="q1" id="q1_3" value="3" <?php if($form['q1']==3){echo 'checked';} ?>>High</td>
                    <td height="60" bgcolor="#F6F6F6">Ideal home environment:</td>
                  <td align="left"><input type="radio" name="q2" id="q2_1" value="1" <?php if($form['q2']==1){echo 'checked';} ?>>Active　<input type="radio" name="q2" id="q2_2" value="2" <?php if($form['q2']==2){echo 'checked';} ?>>Quiet　<input type="radio" name="q2" id="q2_3" value="3" <?php if($form['q2']==3){echo 'checked';} ?>>Both</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">Is the dog good with strangers:</td>
                    <td align="left"><input type="checkbox" name="q3_1" id="q3_1" value="1" <?php if($form['q3_1']==1){echo 'checked';} ?>>Friendly　<input type="checkbox" name="q3_2" id="q3_2" value="1" <?php if($form['q3_2']==1){echo 'checked';} ?>>Shy　<input type="checkbox" name="q3_3" id="q3_3" value="1" <?php if($form['q3_3']==1){echo 'checked';} ?>>Aggressive</td>
                    <td height="60" bgcolor="#F6F6F6">The dog is best with children of<br>what age group:</td>
                  <td align="left"><input type="radio" name="q4" id="q4_1" value="1" <?php if($form['q4']==1){echo 'checked';} ?>>Any ages　<input type="radio" name="q4" id="q4_2" value="2" <?php if($form['q4']==2){echo 'checked';} ?>>under 5 years old　<input type="radio" name="q4" id="q4_3" value="3" <?php if($form['q4']==3){echo 'checked';} ?>>over 5 years old<br><input type="radio" name="q4" id="q4_4" value="4" <?php if($form['q4']==4){echo 'checked';} ?>>over 10 years old　<input type="radio" name="q4" id="q4_5" value="5" <?php if($form['q4']==5){echo 'checked';} ?>>over 15 years old</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">Is the dog good with other dogs(Small):</td>
                  <td align="left"><input type="radio" name="q5" id="q5_1" value="1" <?php if($form['q5']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q5" id="q5_2" value="2" <?php if($form['q5']==2){echo 'checked';} ?>>No</td>
                    <td height="60" bgcolor="#F6F6F6">Is the dog good with other dogs(Big):</td>
                  <td align="left"><input type="radio" name="q6" id="q6_1" value="1" <?php if($form['q6']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q6" id="q6_2" value="2" <?php if($form['q6']==2){echo 'checked';} ?>>No</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">Is the dog good with cats:</td>
                    <td align="left"><input type="radio" name="q7" id="q7_1" value="1" <?php if($form['q7']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q7" id="q7_2" value="2" <?php if($form['q7']==2){echo 'checked';} ?>>No</td>
                    <td height="60" bgcolor="#F6F6F6">Good on leash:</td>
                  <td align="left"><input type="radio" name="q8" id="q8_1" value="1" <?php if($form['q8']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q8" id="q8_2" value="2" <?php if($form['q8']==2){echo 'checked';} ?>>No</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">House-trained:</td>
                  <td align="left"><input type="radio" name="q9" id="q9_1" value="1" <?php if($form['q9']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q9" id="q9_2" value="2" <?php if($form['q9']==2){echo 'checked';} ?>>No</td>
                    <td height="60" bgcolor="#F6F6F6">Crate-trained:</td>
                  <td align="left"><input type="radio" name="q10" id="q10_1" value="1" <?php if($form['q10']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q10" id="q10_2" value="2" <?php if($form['q10']==2){echo 'checked';} ?>>No</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">How is the dog with men:</td>
                    <td align="left"><input type="checkbox" name="q11_1" id="q11_1" value="1" <?php if($form['q11_1']==1){echo 'checked';} ?>>Friendly　<input type="checkbox" name="q11_2" id="q11_2" value="1" <?php if($form['q11_2']==1){echo 'checked';} ?>>Shy　<input type="checkbox" name="q11_3" id="q11_3" value="1" <?php if($form['q11_3']==1){echo 'checked';} ?>>Aggressive</td>
                    <td height="60" bgcolor="#F6F6F6">Food aggression with people:</td>
                  <td align="left"><input type="radio" name="q12" id="q12_1" value="1" <?php if($form['q12']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q12" id="q12_2" value="2" <?php if($form['q12']==2){echo 'checked';} ?>>No</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">Food aggression with dogs:</td>
                    <td align="left"><input type="radio" name="q13" id="q13_1" value="1" <?php if($form['q13']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q13" id="q13_2" value="2" <?php if($form['q13']==2){echo 'checked';} ?>>No</td>
                    <td height="60" bgcolor="#F6F6F6">Has the dog ever bitten anyone:</td>
                  <td align="left"><input type="radio" name="q14" id="q14_1" value="1" <?php if($form['q14']==1){echo 'checked';} ?>>Yes　<input type="radio" name="q14" id="q14_2" value="2" <?php if($form['q14']==2){echo 'checked';} ?>>No</td>
                </tr>
                <tr>
                    <td width="120" height="60" bgcolor="#F6F6F6">Were the dog’s puppies, siblings,<br>canine mother, canine father rescued:</td>
