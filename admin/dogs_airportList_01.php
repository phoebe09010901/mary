	...
	<!----------- 內容 開始 ------------------> 
  	<div class="boardingList_adoption">    
        ...
        <div style="border:#03C 0px solid; width:980px; height:658px;">
			...
			if($dogs) {
				$query = "select distinct Fullkey, text1, text2, text3, text4, text5, ans5, ans6, ans7, ans8, ans9, ans10 from ".$table_name_dogs."_agreement where dog_id='".$dogs['Fullkey']."' and output=1 and adopted=1 order by Fullkey asc";	
			...
			?>
                    <div class="<?=($i%5==0)?'boardingList_adoption_2_all_first':'boardingList_adoption_2_all'?>"><?=$i?>
                        ...
                        <div class="boardingList_adoption_2_2">
                            <span class="t4 font-size_27 line-height_25" style="color:#E84693;"><?=stripslashes($dogs['name'])?></span>
                        </div>
                    </div>
            <?php	
				}
