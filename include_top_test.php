...
?>
	<div class="center_T">
        ...
        <?php if($file == 'index'){ echo "<div class=\"center_btn_Rindex\">"; } else if($file == 'donate') { echo "<div class=\"center_btn_R2\">"; } else { echo "<div class=\"center_btn_R\">";}?>
            ...
            <!-- 小麥這是當清單為0時的樣式 開始 
            <a href="wistlist_01.php">
                <div class="wistlist">
                    <div class="icon"><img src="images/wistlist_icon.png" width="100%"/></div>
                    <div class="text font-family_01 font-size_15 color_01">wistlist (0)</div>
                </div>
            </a>
            小麥這是當清單為0時的樣式 結束 -->
            
            <!-- 小麥這是當清單不為0時的樣式 開始 -->
            <a class="fancybox fancybox.iframe" href="wistlist_01.php">
                <div class="wistlist">
                    <div class="icon"><img src="images/wistlist_icon_02.png" width="100%"/></div>
                    <div class="text font-family_01 font-size_15 color_01">wistlist (10)</div>
                </div>
            </a>
            <!-- 小麥這是當清單不為0時的樣式 結束 -->
